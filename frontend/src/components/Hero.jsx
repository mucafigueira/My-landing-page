        ...
        flex items-end md:items-start md:justify-start justify-center
         overflow-hidden pt-0 pb-12 md:pb-0`}>
            ...
            <div className="relative z-10 w-full max-w-2xl px-4 sm:px-6 lg:px-8 py-8 sm:py-0">
                <div className="space-y-4 md:absolute md:top-4 sm:absolute sm:space-y-6">
                    {/* HEADLINE */}
                    <h1 className="text-2xl text-gray-950 md:mt-0.8 sm:mt-4 sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                        Crio <span className="text-blue-950 sm:mt-[-20px] font-bold text-gradient">websites e sistemas</span> que
