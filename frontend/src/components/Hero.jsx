...
export default function Hero() {
    return (
        <section className="relative w-full min-h-screen md:h-screen flex items-end md:items-start md:justify-start justify-center overflow-hidden pt-0 pb-12 md:pb-0">
            ...
            <div className="relative z-10 w-full max-w-2xl px-4 sm:px-6 lg:px-8 py-8 sm:py-0">
                <div className="space-y-4 md:absolute md:top-10 sm:absolute sm:top-10 sm:space-y-6">
                    ...
                    {/* SUBHEADLINE */}
                    <p className="text-gray-50 text-shadow sm:text-gradient font-semibold text-sm  md:text-lg ">
                    ...
                    {/* PROVA RÁPIDA */}
                    <div className=" font-semibold text-shadow flex flex-col sm:flex-row sm:gap-6 gap-2 pt-6 sm:pt-8 text-xs sm:text-sm text-gray-50">
